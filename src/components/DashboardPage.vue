    ...
    <div class="dashboard-page">
      ...
      <div class="widgets-container">
        ...
        <div class="farm-card" shadow="hover">
          ...
          <el-button class="sell-button" type="warning" @click="submitPigDetails">Sell a Batch</el-button>
        </div>
      </div>
...
export default {
  setup() {
    ...
    const submitPigDetails = () => {
      vm.appContext.config.globalProperties.$router.push('/submit-pig-details'); // Redirect to dashboard
    };
